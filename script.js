...
function attachPhotoUpload(inputId, previewId, iconId){
...
attachPhotoUpload('heroPhotoInput','heroPreview','heroEmoji');
attachPhotoUpload('aboutMainInput','aboutMainPreview','aboutMainIcon');
...
document.getElementById('heroMascot').addEventListener('click',e=>{
  ...
  document.getElementById('heroEmoji').innerHTML=`<i class="fas ${mascots[mascotIdx]}" style="font-size:5rem;color:var(--pink);opacity:.35"></i>`;
